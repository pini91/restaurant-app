...
module.exports = {
  ...
  getReservations: async (req, res) => {
    ...
    const prevYear = dateToday.getFullYear() - 4

    if (prevMonth < 10) { prevMonth = '0' + prevMonth.toString() }
    if (day < 10) { day = '0' + day.toString() }
    // day = day
    ...
    try {
      ...
      res.render('adminReservations.ejs', { reservations, today: danas, maxDate, minDate, selectedDate: danas })
    } catch (err) {
      console.log(err)
    }
  },
  ...
  getDate: async (req, res) => {
    ...
    try {
      ...
      res.render('adminReservations.ejs', { reservations, today: danas, maxDate, minDate, selectedDate: chosenDay })
    } catch (err) {
      console.log(err)
    }
  },
