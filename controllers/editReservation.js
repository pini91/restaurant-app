...
module.exports = {
  ...
  editTable: async (req, res) => {
    ...
    try{
      ...
      let reservationToEdit = await Reservations.find({_id:req.user.reservationId})
  ...
  getEditForm: (req, res) => {
    ...
    res.render("editForm.ejs", { currentDate: currMonth, maxDate: maxDate});
  ...
  editInfo: async (req, res)=>{
    ...
    deleteReservation: async (req, res) => {
      ...
      try {
        // Find post by id
        let reservation = await Reservations.findById({ _id: req.user.reservationId }); //We put this line here to make sure that post exist.
